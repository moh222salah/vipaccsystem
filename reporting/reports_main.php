...
/* ─── STYLE INJECTION ONLY - NO CONTENT CHANGE ─── */
echo "
<style>
    /* الخطوط والخلفية العامة */
    @import url('https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700&display=swap');
    
    body { background: #f0f2f5 !important; font-family: 'Cairo', sans-serif !important; }
    
    /* تحويل الجداول التقليدية لكروت VIP */
    .table_main, .table { 
    ...
    /* تنسيق العناوين الزرقاء */
    .heading { 
        background: linear-gradient(135deg, #0A2342 0%, #164E8F 100%) !important;
    ...
    /* تنسيق الروابط (التقارير) */
    a.rep-link, a[href*='reports_main.php'] {
        display: block !important;
        padding: 10px 15px !important;
        margin: 5px 0 !important;
        background: #f8f9fa !important;
        border-right: 4px solid #D4AF37 !important; /* اللون الذهبي */
        color: #333 !important;
    ...
    a.rep-link:hover {
        ...
        color: #164E8F !important;
    }

    /* تنسيق التقرير المختار حالياً */
    .currentBox {
        background: #164E8F !important;
        color: white !important;
        border-right: 4px solid #D4AF37 !important;
        font-weight: bold !important;
    }

    /* تنسيق الأزرار (عرض التقرير) */
