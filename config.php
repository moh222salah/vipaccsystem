...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	// Main Title
	$app_title = "VIPAccSystem";

	// Build for development purposes
	$build_version 	= date("d.m.Y", filemtime("$path_to_root/CHANGELOG.txt"));

	// Powered by
	$power_by 		= "VIPAccSystem";
	$power_url 		= "http://vipaccsystem.com";
	...
	// 	context help feed from vipaccsystem.com
	$help_base_url = 'http://vipaccsystem.com/fawiki/index.php?n=Help.';
