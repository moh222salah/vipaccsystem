...
function subpage_title($txt) 
{
	...
	echo '<center><img src="'.$path_to_root.'/themes/default/images/logo_vipaccsystem.png" width="250" height="50" alt="Logo" >
		</center>';
...
start_form();
	switch(@$_POST['Page']) {
		...
		case '6': // final screen
			subpage_title(_('VIPAccSystem ERP has been installed successsfully.'));
